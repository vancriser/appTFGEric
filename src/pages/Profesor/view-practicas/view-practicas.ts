...
@IonicPage()
@Component({
  selector: 'page-view-practicas',
  templateUrl: 'view-practicas.html',
})
export class ViewPracticasPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,
    public practicaService: practicaService, private afAuth: AngularFireAuth,
    public profileService: profileService) {

    this.recvData = this.navParams.get('data');
    //metodo que llama a practicaService
    //Se buscan ahí las practicas activas
    //Se añaden a la lista practicasActivas
    practicaService.getPracticasActivas().valueChanges()
      .subscribe(practicasActivas => {
        this.practicasActivas = practicasActivas;
        //filtro para mostrar solo las activas
